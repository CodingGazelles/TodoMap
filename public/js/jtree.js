...
TdNode.prototype = {
    ...
    //      lastNode = this.childNodes.last,
    //      length = this.childNodes.length,
    //      newTotalWeight;
        
    //     newNode.path = this.path + "/" + length;
    //     this.childNodes.push(newNode);
        
    //     if( lastNode){
    //      newNode.weight = lastNode.weight;
    //      newTotalWeight = 100 + newNode.weight;
    //     } else {
    //      newNode.weight = newTotalWeight = 100;
    //     }
        
    //     this.childNodes.forEach(function(node) {
    //         node.weight = node.weight / newTotalWeight;
    //     });
...
TdTree.buildTree = function(data) {
    ...
    (function walkDown(node, parent) {
        ...
        if (!parent) {
            ...
            var newNode = new TdNode(getNodeData(node));
